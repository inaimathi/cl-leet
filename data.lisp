...
(defparameter *tradegoods*
  (list (make-tradegood :price '(3 60 12) :unit "chip" :type 'goods :tech-level 8 :name "Computers") 
	...
	(make-tradegood :price '(4 12) :unit "ton" :type 'goods :tech-level 0 :name "Minerals")))
